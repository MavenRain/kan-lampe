...
import KanLampe.Syntax.State
import KanLampe.Syntax.Utils
import KanLampe.Tp

set_option autoImplicit true

/-!
# KanLampe.Syntax.Builders

Port of `Lampe.Syntax.Builders`.  Builds native `KanLampe` terms from
Noir DSL surface syntax: lenses, patterns, expressions, lambdas,
function decls, trait impls, struct defs, type aliases, trait defs.
-/
...
-- Lean splice (escape hatch): embeds an arbitrary KanLampe `Expr` term.
